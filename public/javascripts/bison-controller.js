    ...
    return {
        init : function(thePage, initCallback, cancelCallback){
            if(isInitialized){
                ...
                //jQuery(myPage).find("#createBoreLogButton").click(function(event){
                //    //$(".content").toggleClass("outro");
                //    promptCallback();
                //    Prompt.render("Customer", "Who&#32;is&#32;this&#32;job&#32;for?", controller.customer, promptCallback);
                //});

                jQuery(myPage).find('#continueBoreLogButton').click(function(event){
                    promptCallback();
                    MyAlert.render("In development", "This feature, much like the rest of my life, is in development...", promptCallback);
                });
        ...
        otherCrap : function(){
            setTimeout(function(){
                ...
                MyAlert.render("The rest is yet to come", "Someday...", promptCallback);
            }, 100);
        }
    };//end return
};
